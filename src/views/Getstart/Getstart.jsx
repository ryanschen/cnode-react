...
export default class extends Component {
  render () {
    return (
      <div className="getstart markdown-text">
        <h2>Node.js 入门</h2>
        <p>《<strong>汇智网 Node.js 课程</strong>》</p>
        <p><a href="http://www.hubwiz.com/course/?type=nodes" target="_blank" rel="noopener noreferrer">http://www.hubwiz.com/course/?type=nodes</a></p>
        ...
        <p><a href="http://www.nodebeginner.org/index-zh-cn.html" target="_blank" rel="noopener noreferrer">http://www.nodebeginner.org/index-zh-cn.html</a></p>
        <h2>Node.js 资源</h2>
